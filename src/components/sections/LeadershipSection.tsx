...
import { 
  Crown, Users, Award, Linkedin, Twitter, Mail,
  Briefcase, GraduationCap, Star, Target, TrendingUp
} from 'lucide-react';
...
const LeadershipSection = () => {
  ...
  const leadership = [
    {
      ...
      description: 'Visionary leader driving digital transformation and innovation across the technology landscape.',
      expertise: ['Strategic Leadership', 'Digital Transformation', 'Business Development', 'Innovation Management'],
      experience: '10+ Years',
      education: 'MBA in Technology Management',
      achievements: ['Built 5+ successful startups', 'Led $10M+ in funding rounds', 'Tech Industry Speaker'],
      social: {
        linkedin: '#',
        twitter: '#',
    ...
    },
    {
      ...
      shortTitle: 'Director',
      avatar: '👩‍💼',
      description: 'Strategic operations director ensuring excellence in project delivery and organizational growth.',
      expertise: ['Operations Management', 'Project Leadership', 'Team Development', 'Quality Assurance'],
      experience: '8+ Years',
      education: 'Masters in Business Administration',
      achievements: ['Scaled operations by 300%', 'ISO certification leader', 'Award-winning project manager'],
      social: {
        linkedin: '#',
        twitter: '#',
    ...
    },
    {
      ...
      avatar: '👨‍💻',
      description: 'Senior advisor providing strategic guidance and governance oversight for sustainable business growth.',
      expertise: ['Corporate Governance', 'Strategic Planning', 'Risk Management', 'Investment Strategy'],
      experience: '15+ Years',
      education: 'PhD in Business Strategy',
      achievements: ['Board member at 10+ companies', 'Investment committee chair', 'Industry thought leader'],
      social: {
        linkedin: '#',
        twitter: '#',
  ...
  return (
    <section id="leadership" ref={sectionRef} className="py-20 lg:py-32 relative overflow-hidden">
      {/* Background elements */}
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className={`text-center mb-16 transition-all duration-1000 ${
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass mb-6">
            ...
            <span className="text-sm font-medium text-gray-300">Leadership Team</span>
          </div>
          ...
          <p className="text-lg text-gray-400 max-w-3xl mx-auto leading-relaxed">
            Our experienced leadership team combines strategic vision with hands-on expertise 
            to guide Nextzenith Ventures Mi Room toward continued success and innovation.
          </p>
        </div>
            ...
            >
              ...
              <div className="relative mb-6">
                ...
                <div className="relative z-10 flex flex-col items-center pt-6">
                  {member.id === 1 ? (
                    <div className={`w-20 h-20 bg-gradient-to-br ${member.color} rounded-full p-1 mb-4 group-hover:scale-110 transition-transform duration-300`}>
                      <ProfileAvatar
                        src={member.avatar}
                        alt={member.name}
                        size={72}
                    ...
                    <div className={`w-20 h-20 bg-gradient-to-br ${member.color} rounded-full flex items-center justify-center text-3xl mb-4 group-hover:scale-110 transition-transform duration-300`}>
                      {member.avatar}
                    </div>
                  )}
                  
                  {/* Title Badge */}
                  <div className={`px-3 py-1 bg-gradient-to-r ${member.color} text-white text-xs font-semibold rounded-full mb-2`}>
                    {member.shortTitle}
                  </div>
                  
                  {/* Name and Position */}
                  <h3 className="text-xl font-bold text-white text-center mb-1">{member.name}</h3>
                  <p className="text-sm text-gray-400 text-center mb-4">{member.position}</p>
                  
                  {/* Status Indicator */}
                  <div className="flex items-center gap-2 mb-4">
                    <div className="w-2 h-2 bg-green-400 rounded-full animate-pulse-dot"></div>
                    <span className="text-xs text-gray-400">Active Leadership</span>
                  </div>
                </div>
              </div>
              ...
              {/* Expertise Tags */}
              <div className="mb-6">
                <h4 className="text-sm font-semibold text-white mb-3">Core Expertise</h4>
              ...
              {/* Hover Overlay */}
              <div className={`absolute inset-0 bg-gradient-to-br ${member.color} opacity-0 group-hover:opacity-5 transition-opacity duration-300 rounded-2xl`}></div>
            </div>
          ))}
        </div>
        ...
        <div className={`transition-all duration-1000 delay-600 ${
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-gray-400 max-w-2xl mx-auto">
              The core values that guide our leadership team in making strategic decisions and driving company growth.
            </p>
          </div>
        ...
        <div className={`text-center mt-16 transition-all duration-1000 delay-800 ${
          ...
          <div className="glass-dark p-8 rounded-2xl max-w-2xl mx-auto">
            ...
            <p className="text-gray-400 mb-6">
              Connect with our experienced leaders to discuss strategic partnerships, investment opportunities, or career prospects.
            </p>
